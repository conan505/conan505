...
- ⚡ **[inferLab](https://github.com/conan505/inferLab)** — a distributed, OpenAI-compatible LLM inference platform built from first principles in Rust and C++: streaming gateway with routing, admission control and circuit breaking; a three-node Raft control plane; a durable batch queue; and a CPU decoder with paged KV cache. Every milestone ships a reproducible proof script and an evidence bundle.
...
- **LLM Systems:** RAG, vector DBs, embeddings, reranking, vLLM, inference serving (SSE streaming, paged KV cache), LangChain/LangGraph
- **Programming:** Go, Rust, Python, Java, C++, TypeScript
- **Infrastructure:** Kubernetes, Docker, Terraform, AWS, GCP; distributed systems, consensus (Raft) & microservices
...
- 📄 Resume: [Resume_Rahul_Garg_2026.pdf](https://rahulgarg.ai/Resume_Rahul_Garg_2026.pdf)
